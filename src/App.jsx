...
function GalleryCard({ painting, onClick }) {
  return (
    ...
    <div className="page-enter">
      ...
      <section aria-labelledby="gallery-heading" style={{ maxWidth:1280, margin:"0 auto", padding:"5rem 2rem 4rem" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(240px, 1fr))", gap:"1rem" }}>
          {PAINTINGS.map((p) => <GalleryCard key={p.id} painting={p} onClick={setModal}/>)}
        </div>
      </section>
...
// ─────────────────────────────────────────────
// BEFORE / AFTER DRAG SLIDER
// Drag left/right to reveal the painting vs reference photo.
